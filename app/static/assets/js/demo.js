...
demo = {
    ...
    initDashboardPageCharts: function() {
        ...
        var dataSales = {
            labels: ['5:00AM', '7:00AM', '9:00AM', '11:00AM', '1:00PM', '3:00PM', '5:00PM'],
            series: [
                [287, 385, 490, 492, 554, 586, 698, 695, 752, 788, 846, 846],
                [300, 350, 275, 400, 500, 430, 435, 437, 539, 542, 544, 5444],
                [23, 80, 100, 108, 190, 239, 30, 20, 45, 70, 100, 100]
            ]
        };
    ...
    showNotification: function(from, align) {
        ...
        $.notify({
            icon: "nc-icon nc-app",
            message: "Welcome Back! How have you been going?"
